...
async def start(client, message):
        ...
        for msg in msgs:
            ...
            try:
                await client.send_cached_media(
                    ...
                    caption=f_caption,
                    reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton("⚡ Jᴏɪɴ Oᴜʀ Gʀᴏᴜᴘ ⚡", url="https://t.me/+OoQ15-h3FjA3Mzc1") ] ] ),
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton("Jᴏɪɴ Gʀᴏᴜᴘ", url="https://t.me/+OoQ15-h3FjA3Mzc1"),
